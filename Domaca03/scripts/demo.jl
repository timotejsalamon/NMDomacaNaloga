...
#' Izrišemo nihanje.
plot([nihalo(l, t, theta0, dtheta0, n) for t in thetaRange], 
             title="Matematično nihalo", label="Matematično nihalo")
...
plot!([harmOsc(l, t, theta0, n) for t in thetaRange],
               title="Matematično vs Harmonično nihalo", label="Harmonicno nihalo")

#' Poglejmo nihanje za različne dolžine nihala
thetaRange = 1:0.1:120
plot([nihalo(3, t, theta0, dtheta0, n) for t in thetaRange], 
             title="Primerjava različnih dolžin nihala", label="l = 3")
...
plot(thetaRange, T, xlabel="Začetni kot (rad)", ylabel="Nihajni čas (s)",
     title="Nihajni čas v odvisnosti od začetnega kota")
...
plot(energije, nihajniCasi, xlabel="Energija (J)", ylabel="Nihajni čas (s)", 
     title="Nihajni čas v odvisnosti od energije nihala", label="m = 1")
